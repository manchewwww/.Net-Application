    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterDatabase()
                .Annotation("Npgsql:Enum:public.address_type", "shipping,billing")
                .Annotation("Npgsql:Enum:public.delivery_type", "address,office,locker,pickup_point")
                .Annotation("Npgsql:Enum:public.fitment_type", "direct_fit,requires_mod,universal")
                .Annotation("Npgsql:Enum:public.order_status", "new,paid,packing,shipped,delivered,cancelled,refunded")
                .Annotation("Npgsql:Enum:public.part_number_type", "oem,ean,upc,interchange,manufacturer")
                .Annotation("Npgsql:Enum:public.payment_status", "pending,authorized,captured,failed,refunded")
                .Annotation("Npgsql:Enum:public.return_status", "requested,approved,received,rejected,refunded")
                .Annotation("Npgsql:Enum:public.shipment_status", "created,in_transit,delivered,lost,returned")
                .Annotation("Npgsql:Enum:public.stock_movement_type", "purchase,sale,return,adjustment,transfer_in,transfer_out,reserve,release");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_brands_countries_country_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    quote_currency_id = table.Column<long>(type: "bigint", maxLength: 3, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_exchange_rates_currencies_base_currency_id",
                        column: x => x.base_currency_id,
                        principalTable: "currencies",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_exchange_rates_currencies_quote_currency_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_price_lists_countries_country_id",
                        column: x => x.country_id,
                        principalTable: "countries",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_price_lists_currencies_currency_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    type = table.Column<int>(type: "address_type", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    delivery_type = table.Column<int>(type: "delivery_type", nullable: false),
                    ...
                    shipping_country_id = table.Column<long>(type: "bigint", maxLength: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_orders_countries_shipping_country_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_supplier_parts_currencies_currency_id",
                        column: x => x.currency_id,
                        principalTable: "currencies",
                        principalColumn: "id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    order_id = table.Column<long>(type: "bigint", nullable: false),
                    status = table.Column<int>(type: "return_status", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_part_attributes", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    part_id = table.Column<long>(type: "bigint", nullable: false),
                    type = table.Column<int>(type: "part_number_type", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_part_numbers", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    part_id = table.Column<long>(type: "bigint", nullable: false),
                    warehouse_id = table.Column<long>(type: "bigint", nullable: false),
                    type = table.Column<int>(type: "stock_movement_type", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    id = table.Column<long>(type: "bigint", nullable: false),
                    fitment = table.Column<int>(type: "fitment_type", nullable: false),
                    notes = table.Column<string>(type: "text", nullable: true),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "now()"),
                    updated_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "now()")
                },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_exchange_rates_base_currency_id_quote_currency_id_as_of",
                table: "exchange_rates",
                columns: new[] { "base_currency_id", "quote_currency_id", "as_of" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_exchange_rates_quote_currency_id",
                table: "exchange_rates",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_orders_shipping_country_id",
                table: "orders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_price_lists_country_id",
                table: "price_lists",
                column: "country_id");

            migrationBuilder.CreateIndex(
                name: "IX_price_lists_currency_id",
                table: "price_lists",
                column: "currency_id");

            migrationBuilder.CreateIndex(
                name: "IX_price_lists_name_currency_id_country_id",
                table: "price_lists",
                columns: new[] { "name", "currency_id", "country_id" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_supplier_parts_currency_id",
